    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6"><h5 class="card-title mb-0">Tambah Kelurahan/Desa</h5></div>
                    <div class="col-md-6"><a href="{{ route('index.kelurahan') }}" class="btn btn-sm btn-secondary float-end">Kembali</a></div>
                </div>
            </div>
            <form action="{{ route('store.kelurahan') }}" method="post" autocomplete="off">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-6">
                            ...
                            <select name="kecamatan_kode" id="kecamatan" class="form-select" disabled>
                            </select>
                        </div>
                    </div>
                    <div class="row mt-2">
