    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6"><h5 class="card-title mb-0">Tambah User Admin</h5></div>
                    <div class="col-md-6"><a href="{{ route('admin.user') }}" class="btn btn-sm btn-secondary float-end">Kembali</a></div>
                </div>
            </div>
            <form action="{{ route('store.admin') }}" id="data-form" method="post" class="fv-plugins-bootstrap5" autocomplete="off">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-12">
                            ...
                            <input type="password" name="konfirmasi_password" class="form-control {{ $errors->has('password') ? 'is-invalid' : '' }}"
                             value="{{ old('password') }}" required>
                        </div>
                    </div>
                    <div class="row mt-2">
