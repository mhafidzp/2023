    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6"><h5 class="card-title mb-0">Ubah Provinsi</h5></div>
                    <div class="col-md-6"><a href="{{ route('index.provinsi') }}" class="btn btn-sm btn-secondary float-end">Kembali</a></div>
                </div>
            </div>
            <form action="{{ route('update.provinsi') }}" method="post" autocomplete="off" id="data-form">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="kode" class="form-control {{ $errors->has('kode') ? 'is-invalid' : '' }}"
                             value="{{ old('kode', $provinsi->kode) }}" required>
