    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6"><h5 class="card-title mb-0">Tambah Kota/Kab</h5></div>
                    <div class="col-md-6"><a href="{{ route('index.kota') }}" class="btn btn-sm btn-secondary float-end">Kembali</a></div>
                </div>
            </div>
            <form action="{{ route('store.kota') }}" method="post" autocomplete="off" id="data-form">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                ...
                fields: {
                    ...
                    'kode': {
                        validators: {
                            ...
                            remote: {
                                url: "{{ route('cek-kode.kota') }}",
                                data: function () {
                                    return {
                                        kode: form.querySelector('[name="kode"]').value,
                                    };
                                },
                                message: 'Kode Kota/Kab sudah digunakan.',
                                type: 'GET',
                            }
                        }
                    },
